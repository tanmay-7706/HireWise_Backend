...
├── controllers/
│   └── oAuth.js               # Google OAuth controller
├── data/
│   └── mockJDs.js             # Mock job descriptions
├── middleware/
...
│   ├── JobDescription.js      # Job description schema
│   ├── Interview.js           # Interview schema
│   └── CareerRoadmap.js       # Career roadmap schema
├── routes/
│   ├── auth.js                # Authentication routes
│   ├── resume.js              # Resume routes
│   ├── jd.js                  # Job description routes
│   ├── interview.js           # Interview routes
│   ├── career.js              # Career roadmap routes
│   ├── user.js                # User routes
│   └── mockjd.js              # Mock JD routes
├── services/
